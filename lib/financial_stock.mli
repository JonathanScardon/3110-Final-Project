...
(** [update_stock_prices user_id] update's the user [user_id]'s stocks with 
    up-to-date data and loads it into their stock CSV file *)

val calculate_portfolio_value : string -> float
(** [calculate_portfolio_value user_id] return's the total value of all of user 
    [user_id]'s stocks as a float*)
